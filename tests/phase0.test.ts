...
const rec = (o: Partial<BetRec>): BetRec => ({
  ...
  decisionId: null, createdAt: o.createdAt ?? "2026-07-24T18:00:00Z", kickoffAt: o.kickoffAt ?? null, exitCodeVersion: o.exitCodeVersion ?? null, exits: [], catchUp: false, unmarkedBook: false, ftBlind: false,
});
