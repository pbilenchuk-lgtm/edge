...
export function migrateTennisPmvStrategy(db: Database): void {
  ...
  R.upsertSport(db, "tennis", "Теннис");
  R.insertStrategy(db, {
    id: "tennis_pmv", sport_id: "tennis", name: "Tennis PMV", tag: "консистентность пропов",
    color: "#6fcf97", version: 1, model: "Claude Opus 4.8", model_live: "Claude Opus 4.8",
    created_at: new Date().toISOString(), prompt: STRAT_PMV_DESC, prompt_live: STRAT_PMV_DESC, params: {},
  });
}
