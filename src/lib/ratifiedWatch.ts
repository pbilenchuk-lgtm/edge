...
export interface RatifiedFeature {
  ...
  marker: string;              // подстрока в trade_log.text, которую пишет ТОЛЬКО этот путь
...
export const RATIFIED: RatifiedFeature[] = [
  { key: "quasi_locked_tail", marker: "quasi_locked_tail", ratifiedAt: "2026-07-24",
    what: "тейк подавлен, потому что счёт математически запер рынок — хвост досиживается до резолюции (R1)" },
  { key: "thesis_cap_clamp", marker: "thesis_cap_clamp", ratifiedAt: "2026-07-27",
    what: "тезисный кэп подрезал заливку (не заблокировал целиком)" },
  { key: "ft_blind_placeholder", marker: "ft_blind_placeholder", ratifiedAt: "2026-07-28",
