...
export const RATIFICATIONS: Ratification[] = [
  ...
  {
    id: "d3a-group-bias-detector", at: "2026-08-03", source: "батч-13 D3, решение владельца после пересчёта",
    statement: "ДЕТЕКТОР лигового слома строится как измерение (окно 30 СИГНАЛОВ × группа, p<0.01 на сигналах) и встаёт строкой в еженедельник; вмешательства не несёт",
    status: "deployed", lateDays: 0,
    closedBy: "#124 (groupBiasDetector: интервенции нет в коде вовсе, единица — производственный collapseToSignals)",
  },
  {
    id: "d3b-group-intervention", at: "2026-08-03", source: "батч-13 D3, решение владельца",
    statement: "защитный режим группы (min-edge +3пп / пауза входов) армится ТОЛЬКО созревшим сигнальным критерием И словом владельца — условие «дисперсия отвергнута» на 03.08 НЕ выполнено",
    status: "pending", closedBy: null,
  },
  {
    id: "p-value-names-its-unit", at: "2026-08-03", source: "чат, правило класса",
    statement: "любое p-value, произнесённое в проекте, обязано называть свою единицу («p=0.16 на 9 сигналах») — прививка от четвёртого экземпляра подмены единицы измерения",
    status: "deployed", lateDays: 0,
    closedBy: "#124 (signals.pWithUnit рядом с примитивами значимости; применён в детекторе и форензике)",
  },
  {
